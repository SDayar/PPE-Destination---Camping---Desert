...
input[type=submit]{
  ...
  header{
    background-image:url(../images/Océanie.jpeg);
    width:100%;
...
.sous {
   ...
   <fieldset>
        ...
        <fieldset> 
            <img src="../images/pinn.jpg" style="width:1400px;height:600px;float:center; ">
          <h2>AUSTRALIE</h2> 
          <h2 style="color:darkblue;">Le désert de simpson</h2>
