...
@media only screen and (max-width: 300px) {
 ...
 input[type=submit]{
  ...
  header{
    background-image:url(../images/Amérique.jpg);
    width:100%;
...
.search button{
 ...
 .sous {
    ...
    <center><section>
        ...
        <fieldset>
            <img src="../images/chili.jpg" style="width:600px;height:350px;float:left; ">
             <h2>CHILI</h2>
             <h2 style="color:darkblue;">Le désert d'Atacama</h2>
            
            <p>Un désert paradisiaque par son immensité et par sa beauté, le désert d'Atacama est connu pour être une des régions les plus arides sur Terre. En passant aux pieds des grandioses Miniques, Licancabur et Tunupa, ce cheminement à travers l'Altiplano nous conduit de salars en lagunes.</p>
        ...
        <fieldset> 
          <img src="../images/white sands.jpg" style="width:600px;height:350px;float:left; ">
          <h2>ETATS-UNIS</h2>
          <h2 style="color:darkblue;">Le white sands</h2>
